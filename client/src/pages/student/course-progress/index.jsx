  ...
  return (
    <div className="flex flex-col h-screen bg-[#1c1d1f] text-white">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div
          className={`fixed top-[64px] right-0 bottom-0 w-[400px] bg-[#1c1d1f] border-gray-700 transition-all duration-300 ${
        ...
        >
          <Tabs defaultValue="content" className="h-full flex flex-col">
            <TabsList className="grid bg-[#1c1d1f] w-full grid-cols-2 p-0 h-14">
              <TabsTrigger
                value="content"
                className="text-black border-r rounded-none h-full bg-white"
              >
                Course Content
              </TabsTrigger>
              <TabsTrigger
                value="overview"
                className="text-black rounded-none h-full bg-white"
              >
                Overview
              </TabsTrigger>
            </TabsList>
      ...
      <Dialog open={showCourseCompleteDialog}>
        <DialogContent showOverlay={false} className="sm:w-[425px]">
          <DialogHeader>
            <DialogTitle>Congraluations!</DialogTitle>
